...
namespace bond { namespace ext { namespace gRPC { namespace detail {
    ...
    public:
        ...
        /// number of threads depending on the hardware's available concurrency
        /// will be started.
        ...
        ///
        /// @remarks A cq_poller cannot be restarted after it has been shutdown.
        void start()
        {
            BOOST_ASSERT(_cq);
        ...
        /// @remarks Can be called from multiple threads concurrently.
        ///
        /// @warning Cannot be called from a cq_poller worker thread. In other
        /// words, never call this function from inside of
