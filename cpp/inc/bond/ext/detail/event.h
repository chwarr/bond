...
namespace bond { namespace ext { namespace detail {
    ...
    ///
    /// @remarks This class only provides a \ref set method. It intentionally
    /// does not have a \p reset method to avoid the potential for waiters
    /// missing a signal if \p set and \p reset were to be called in quick
    /// succession.
    class event final
    {
    public:
        ...
        /// @brief Waits at least \p timeout for the event to enter the signaled
        /// state.
        ///
